...
# beam search
def init_beam(beam, cnt=50, score_0=0.0, loss_0=0.0, hs0=None, s0_com=None, s0_pri=None, dyn_dec_tup=None):
    del beam[:]
    ...
    if dyn_dec_tup is not None:
        beam[0].append((loss_0, dyn_dec_tup, s0_com, s0_pri, BOS, 0))
    else:
        beam[0].append((loss_0, s0_com, s0_pri, BOS, 0))
